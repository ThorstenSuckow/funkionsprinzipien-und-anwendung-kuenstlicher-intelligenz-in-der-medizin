...
%------------------------- Titelblatt -------------------------------------
\title{\begin{center}
		   Eine Einführung in mathematische Modelle der biologischen Nervenzelle als Bausteine künstlicher neuronaler Netze
		   und deren Anwendung im Gesundheitswesen
\end{center}}
\project{\begin{center}Zulassungsarbeit zum Master-Fernstudium\end{center}}
%--------------------------------------------------------------------------
\supervisor{Titel Vorname Name} 		% Betreuer der Arbeit
\author{\begin{center}
			Thorsten Suckow-Homberg
\end{center}}							% Autor der Arbeit
\address{\begin{center}Aachen, 24.09.2023\end{center}} 							% Im Zusammenhang mit dem Datum wird hinter dem Ort ein Komma angegeben
...
\input{chapters/1. Einführung/index}
\input{chapters/2. Das Neuron/index}
\input{chapters/3. Kuenstliche Neuronen/index}
\input{chapters/4. Kuenstliche Neuronale Netze/index}
\input{chapters/5. Neuronale Netze im Gesundheitswesen/index}
\input{chapters/6. Zusammenfassung und Bemerkung/index}
