\section{Das Rosenblatt-Perzeptron}
...
Für beliebige Punkte $(x_1, x_2) \in \mathbb{R}^2$ gilt offensichtlich
...
Formal ausgedrückt bedeutet das, dass $M_+$ und $M_-$ \textit{linear separierbar} sind. Nach \textit{Rojas} lautet die Definition für \textit{Lineare Trennbarkeit}:
