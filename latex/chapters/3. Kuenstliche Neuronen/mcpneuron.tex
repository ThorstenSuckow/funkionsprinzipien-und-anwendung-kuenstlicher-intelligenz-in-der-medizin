...
Die \textbf{disjunktive Normalform} (Gleichung~\ref{eq:gl-xordis}) und die \textbf{konjunktive Normalform} (Gleichung~\ref{eq:gl-xorcon}) von \textbf{XOR} liefern die Formel für das Netz, wobei insbesondere die disjunktive Normalform die abgebildete Verschaltung in Abbildung~\ref{fig:mcpxorf} erklärt.\\
