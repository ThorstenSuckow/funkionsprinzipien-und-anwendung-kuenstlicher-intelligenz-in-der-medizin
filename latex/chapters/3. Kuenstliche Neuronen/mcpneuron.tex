...
Bereits $\{\neg, \land\}$ reichen aus, um dieses Ziel zu erfüllen\footnote{wie \textit{Sheffer} in~\cite{She13} zeigt}. \textbf{NAND} (Tabelle~\ref{tab:nand}) kann in einem MCP-Netz folgendermaßen modelliert werden:
