...
}~\cite[108]{MP43}. Insgesamt gehen sie von folgenden physischen Eigenschaften von Nervenzellen aus\footnote{siehe~\cite[101]{MP43}}:
...
Für ein ausführliches Beispiel zur Modellierung eines MCP-Netzes unter Berücksichtigung von Zeiteinheiten sei auf Anhang~\ref{appendix:paradoxehitzeempfindung} verwiesen.
