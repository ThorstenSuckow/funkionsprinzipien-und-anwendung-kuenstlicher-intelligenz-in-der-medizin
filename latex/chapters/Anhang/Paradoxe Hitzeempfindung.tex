...
\begin{figure}[h]
    ...
    \includegraphics[
        width=8cm,
        keepaspectratio,
    ]{chapters/Anhang/mcpparadoxheat}
    \caption{MCP-Netz zur Modellierung der paradoxen Hitzeempfindung (Quelle~\cite[31, Figure 1.18]{Fau94}, Darstellung eigene).}
    \label{fig-mcpheat}
\end{figure}
...
\begin{figure}[h]
    ...
    \includegraphics[
        width=8cm,
        keepaspectratio,
    ]{chapters/Anhang/mcptwocold}
    \caption{Zwei Kälteimpulse werden nacheinander in das Netz gespeist (Quelle~\cite[35, Figure 1.23]{Fau94}, Darstellung eigene).}
    \label{fig-coldimp}
\end{figure}
...
\begin{table} %[hbtp]
    ...
    \begin{tabular}{c | c | c | c | c | c | c}
        ...
        $t$   &       &       & 0         & 1         & 0        & 1        \\
    \end{tabular}
    \caption{Tabellarische Darstellung von zwei Kälteimpulsen. Vgl. Abbildung~\ref{fig-coldimp}.}
    \label{tab:coldimp}
\end{table}
...
\begin{figure}[h]
    ...
    \includegraphics[
        width=8cm,
        keepaspectratio,
    ]{chapters/Anhang/mcponehot}
    \caption{Ein einzelner Wärmeimpuls aktiviert das Wärmesignal (Quelle~\cite[36, Figure 1.24]{Fau94}, Darstellung eigene).}
    \label{fig-heatimp}
\end{figure}
...
\begin{figure}[h]
    ...
    \includegraphics[
        width=8cm,
        keepaspectratio,
    ]{chapters/Anhang/mcponecold}
    \caption{Die paradoxe Hitzeempfindung durch einen einzelnen Kälteimpuls (Quelle~\cite[34, Figure 1.22]{Fau94}, Darstellung eigene).}
    \label{fig-heatparad}
\end{figure}
