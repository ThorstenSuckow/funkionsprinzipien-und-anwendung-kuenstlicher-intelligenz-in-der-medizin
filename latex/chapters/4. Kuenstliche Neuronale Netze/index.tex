...
Mit den in den 80er Jahren verfügbaren Supercomputer und Parallelrechner\footnote{
...
} erhält auch der Konnektionismus Auftrieb, der \textbf{neuronale Netze} als Grundlage hat (vgl.~\cite[15]{Dor91}), und mit dem sich Modelle wieder mehr an den biologischen Vorbildern orientieren sollten\footnote{
...
Ein \textbf{mehrschichtiges Perzeptron} (MLP, \textit{multi-layer perceptron})~\cite[6]{GBC18} ist in der Lage, nicht linear-separable Daten zu klassifizieren.
