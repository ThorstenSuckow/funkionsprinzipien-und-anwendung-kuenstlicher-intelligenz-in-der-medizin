...
\begin{figure}[h]
 ...
 \caption{Aufbau einer Nervenzelle. (Quelle: in Anlehnung an~\cite[S. 43, Tafel 2.1]{SD07})}
 \label{fig:neuron}
 \end{center}
 \small{
...
\begin{table} %[hbtp]
 ...
 \begin{tabular}{l | c | c | c }
  ...
  $Cl^-$     & 150 & 13 & 11,5 : 1 \\
 \end{tabular}
 \caption{Ionenkonzentration eines Neurons in Ruhe (Quelle: ~\cite[S. 75, Abb. 3.15]{BCP18})}
...
\begin{figure}[htpb]
 ...
 \caption{Ionenverteilung im Zytosol und der EZF. (Quelle: in Anlehnung an~\cite[S. 72, Abb. 3.13]{BCP18})}
...
\begin{figure}[h]
 ...
 \caption{Aktionspotenzial. (Quelle: in Anlehnung an~\cite[S. 47, Tafel 2.3]{SD07})}
