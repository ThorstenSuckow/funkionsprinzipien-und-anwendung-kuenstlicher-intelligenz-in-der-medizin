...
Die Fortleitung geschieht in Richtung der Axonterminal, wo sich die präsynaptischen Endigungen befinden und das elektrische Signal in chemische Signale umgewandelt werden (siehe Abbildung~\ref{fig:neuron}). Diese Signale werden in der postsynaptischen Zelle ``verrechnet``, und gemäß dem \textbf{Alles-oder-Nichts-Prinzip} entscheidet sich dann, ob wieder ein Signal ausgelöst wird.
