...
Dabei wurde ein anderer neurobiologischer Prozess, der heutzutage bei maschinellen Lernenverfahren Standard ist, nicht von ihnen berücksichtigt: Die dynamische Anpassung des Netzes \footnote{
...
Zu erwähnen ist auch die Bemerkung von McCulloch und Pitts bzgl. ``Berechenbarkeit``:
...
In \textit{Perceptrons - An introduction to Computational Geometry (1969)}~\cite{MP88} behandelt er zusammen mit \textit{Papert} u.a. das Verhalten des Perzeptrons im Fall nicht-separierbarer Daten\footnote{
    in~\cite[181 ff.]{MP88}
...
Die in Kapitel~\ref{ch:knn} vorgestellten Architekturen und Algorithmen sorgten dann zusammen mit dem technologischen Fortschritt für ein erneutes Aufleben der Forschung an neuronalen Netzen und Künstlicher Intelligenz in den 80er Jahren.
