...
Die Ähnlichkeiten zu der in **Kapitel 2.1.3** beschriebenen Aktivierungsfunktion sind ersichtlich. Rosenblatt selber weist darauf hin, dass er sein Modell direkt von dem von McCulloch und Pitts eingeführten Modell ableitet. Darüber hinaus weist er auch auf Einflüsse von Hebb und von Neumann hin <R>Ros62, S.5</R>.
...
Für eine Eingabe folgt, das sie entweder zu $0$ oder zu $1$ evaluiert. Wir haben es hier also wieder mit einem binären Wertebereich zu tun, den wir mit Hilfe der Eingabe- und Aktivierungsfunktion geometrisch darstellen können. Zur Veranschaulichung schauen wir uns die _1. Winkelhalbierende_ im 2-dimensionale kartesischen Koordinatensystem an.
Die zugehörige _Gerade_ $L$ <R>Fis19, S. 18</R> ist
...
$L$ repräsentiert eine _Hyperebene_ <R>BHW+12 S. 81, "Definition 2.3"</R> in $\R^2$. Punkte, die nicht zu dieser Hyperebene gehören, liegen in dem Fall $\R^2$ in zwei unterschiedlichen _Halbräumen_[^17][QUELLE?]. Die Halbräume und deren Trennung wird greifbarer durch die geometrische Darstellung in **Abbildung 2.2.4**. Wir können feststellen, dass alle Punkte, die $x_1 - x_2 > 0$ erfüllen in dem Halbrum **unter** der durch $L$ beschriebenen Gerade liegen; Punkte, für die  $x_1 - x_2 < 0$ gilt, liegen darüber.

**Abbildung 2.2.4:** Die zwei durch die 1. Winkelhalbierende entstandenen Halbräume


[^16]: Definitionen aller Zustände, Signale und Funktionen in <R>Ros62, S. 79 - 94</R>
[^17]: Renze, John; Uznanski, Dan; and Weisstein, Eric W. "Half-Plane." From MathWorld--A Wolfram Web Resource. https://mathworld.wolfram.com/Half-Plane.html (abgerufen 21.08.2023)
