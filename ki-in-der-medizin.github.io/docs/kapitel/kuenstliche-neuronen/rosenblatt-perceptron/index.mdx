...
[^11]: In der Presse publikumswirksam, aber wenig vertrauenserweckend: "Frankenstein Monster Designed by Navy Robot That Thinks" <R>Ros62, S. v</R>. Vgl. dazu Schlagzeilen der hiesigen Boulevardpresse. bild.de titelt: "Übernehmen Computer die Weltherrschaft?" (https://www.bild.de/news/ausland/news-ausland/experten-warnen-ki-so-gefaehrlich-wie-pandemien-und-atomkrieg-84130180.bild.html, abgerufem 27.08.2023) als Reaktion auf "Statement on AI Risk" des _Center for AI Safety_, einem, Statement zahlreicher Wissenschaftler, die zur Vorsicht beim Umgang, Einsatz udn Forschung von KI mahnen: "Mitigating the risk of extinction from AI should be a global priority alongside other societal-scale risks such as pandemics and nuclear war." (https://www.safe.ai/statement-on-ai-risk, abgerufen 27.08.2023)
...
Die Eigenschaft linearer Trennbarkeit von Daten ist eine wesentliche Voraussetzung dafür, dass ein Perzeptron _konvergiert_: Die _Lernregel_ des Perzeptrons passt während der Laufzeit die Gewichte $w_1 ... w_n$ solange an, bis sie - eingesetzt in eine lineare Gleichung <R>Ert1, S. 311</R> - die $n$-dimensionalen Daten entsprechend **Definition 2.2.1** _klassifizieren_ kann. Aus diesem Grund wird das Perzeptron auch **linearer Klassifizierer** genannt <R>Ert21, S. 210 - 216</R>.
...
## 2.2.3 Implementierung in Python
...
[^34]: _Arbib et al_ berufen sich auf das Konvergenz-Theorem und führen an, dass "[das Rosenblatt Perzeptron] does not yield an endless seesaw, but will eventually converge to a correct set of weights if one exists, albeit perhaps after many iterations through the set of trial patterns." <R>Arb03, S. 20, rechte Spalte, Abs. 1</R>: _Minsky und Papert_ stellen fest: "Usually, when a failure occurred, neither prolonging the training experiments nor building larger machines helped." <R>MP17, S. xix, Abs. 3</R>

## 2.2.4 Der AI-Winter

_Minsky_ und _Papert_ führen in <R>MP17</R> weitere Limitationen des Rosenblatt-Perzeptrons auf, u.a. die _connectedness_, in dem sie zeigen, dass eine Perzeptron nicht in der Lage ist, zu entscheiden, ob eine geometrische Figure zusammenhängend ist <R>MP17, S. 12, "Theorem 08"</R>. In dem Kapitel "introduction" führen sie ein, dass

> "hundreds of projects and experiments [bzgl. Perzeptrons] were generally disappointing, and the explanations inconclusive. The machines usually work quite well  on very simple problems but detoriate very rapidly as the tasks assigned to the get harder." <R>MP17, S. 19. Abs. 3</R>

Bereits früher standen Wissenschaftler dem Perzeptron und den damit einhergehenden Versprechen <R>MP17, Konvergenz-Theorem . S. 164</R> skeptisch egegenüber:

> "Here was a machine that could do pattern recognition in a humanlike way; it could recognize all kinds of things. Almost
everyone at MIT was very skeptical" <R>Cow98, S. 99</R>

und <R>AR88, S. 159</R> führt aus, dass bereits vor erscheinen von <R>MP17</R> im Jahr 1969 das Interesse an Perzeptronen zurückging, bevor _Minsky und Papert_ auf Seite 232 feststellen, dass "we [Minsky und Papert] consider it to be an important research problem to elucidate (or reject) our intuitive judgement that the extension is sterile.", dem <R>AR88, S. 159</R> eine generelle Irritation und Enttäuschung mit dem Perzeptron Modell beimessen. Diesem "Pessimismus" betrachten _Minsky und Papert_ 1988 rückblickend in <R>MP17. S xxi</R> und sind sich dessen bewusst, das behauptet wird, ihr Buch hätte mit dem Aufzeigen der Limitierungen des Rosenblatt-Modells Forscherdrang an ebendiesem gebremst.

> "One popular version is  that the publication of our book so discouraged research on learning in network machines that a promising line of reasearch was interrupted." <R>MP17, S. xx</R>

_Anderson und Rosenfeld_ verweisen auf <R>Cow90</R>. In dem Interview geht Cowan auf "the influence of Marvin Minsky and Seymour Papert on the loss of interest in neural networks during the 1970s" <R>AR98, S. X</R> ein.
