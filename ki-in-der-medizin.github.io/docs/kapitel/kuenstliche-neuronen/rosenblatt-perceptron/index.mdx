...
Die Eigenschaft linearer Trennbarkeit von Daten ist eine wesentliche Voraussetzung dafür, dass ein Perzeptron _konvergiert_: Die _Lernregel_ des Perzeptrons ändert während der Laufzeit die Gewichte $w_1 ... w_n$ an, bis eine Gleichung gefunden ist, die $n$-dimensionale Daten entsprechend **Definition 2.2.1** _klassifiziert_, sofern sie linear separabel sind. Aus diesem Grund wird das Perzeptron auch **linearer Klassifizierer** genannt <R>Ert21, S. 210 - 216</R>.
