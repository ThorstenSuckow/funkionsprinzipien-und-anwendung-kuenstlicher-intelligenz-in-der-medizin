...
meinen _Anderson und Rosenfeld_ eine generelle Irritation und Enttäuschung über das Perzeptron-Modell zu erkennen. Diesen "Pessimismus" betrachten _Minsky und Papert_ 1988 in Retrospektive <R>MP17. S xxi</R> und sind sich der Behauptung bewusst, ihr Buch hätte mit dem Aufzeigen der Limitierungen des Rosenblatt-Modells den Forscherdrang an ebendiesem gebremst.
