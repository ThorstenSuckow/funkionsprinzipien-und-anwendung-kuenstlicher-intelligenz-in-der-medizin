...
$L$ repräsentiert eine _Hyperebene_ in $\R^2$. Punkte, die nicht zu dieser Hyperebene gehören, liegen in dem Fall $\R^2$ in zwei unterschiedlichen Halbräumen. Die Halbräume und deren Trennung wird greifbarer durch die geometrische Darstellung in **Abbildung 2.2.4**. Informell können wir feststellen, das alle Punkte, die $x_1 - x_2 > 0$ erfüllen in dem Halbrum **unter** der durch $L$ beschriebenen Gerade liegen; Punkte, für die  $x_1 - x_2 < 0$ gilt, liegen darüber.
