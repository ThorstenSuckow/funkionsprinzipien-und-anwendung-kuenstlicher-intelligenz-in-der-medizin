...
Bereits 1954 wurden Versuche unternommen, lernfähige neuronale Netze zu modellieren <R>Ros62, S. 24, Abs. 2</R>[^10]. Erst 1958 schafft es ein Modell, eine Sensation auszulösen <R>AR88, S.90</R>: Das Perzeptron. Bereits 1957 beschreibt es sein Schöpfer Frank Rosenblatt (1928 - 1971)[^12] als Teil eines internen Forschungsprojektes des Cornell Aeronautical Labors: Die Forschungseinrichtung gehörte von 1946 bis 1972[^13] zu der Cornell Universität[^14], an der Rosenblatt 1950 seinen A.B und 1956 seinen Ph.D. gemacht hatte, und an der er bis zu seinem Lebensende[^15] als Psychologe und Neurobiologe forschen und lehren wird <R>Ehb71</R>.

In dem Forschungsprojekt "_Perceiving and Recognizing Automaton_" ging es um einen Apparat, der mittels einer Kamera und entsprechender Schaltkreise dazu in der Lage war, Muster zu erkennen. Die Maschine wurde bereits 1957 in <R>Ros57</R> beschrieben zunächst auf einem IBM 704 Rechner simuliert<R>Ros60, </R>, bevor sie Anfang der 60er Jahre als _Mark 1 Perceptron_ gebaut wurde: 400 Cadmiumsulfid-Photozellen, die ein 20x20 Pixel großes Bild repräsentieren, wurden entsprechend der erkannten Muster angesteuert aktiviert <R>Bis06, S. 193 "Frank Rosenblatt" sowie S. 196 Figure 4.8</R>.
