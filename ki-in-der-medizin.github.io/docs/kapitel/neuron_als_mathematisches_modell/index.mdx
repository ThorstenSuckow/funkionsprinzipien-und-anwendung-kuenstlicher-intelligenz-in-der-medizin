...
definieren wir _Gewichte_ $w_+ = 2$[^11] für erregende Signale, $w_- = -1$ für hemmende Signale (vgl. <R>Fau94, S. 27-28</R>).
...
[^11]: In Anlehung an das Original wählen wir $w_+ = 2$, siehe auch **Abbildung 2.1**
[^12]: "Wir haben oben nichts uber Gewichte bei hemmenden Verbindungen gesagt, da Gewichte in absolut hemmenden Leitungen unsinnig sind."<R>Roj93, S. 42, Abs. 1</R>
