...
Doch seine Arbeit hierdran stagniert, und es soll bis zu seiner Berufung an das Neuropsychiatrische Institut der Universität von Illinios im Jahr 1941 dauern, bis er Walter Pitts kennenlernt, mit dem er gemeinsam das Kalkül erarbeitet.
...
Pitts selber gilt als brillianter Mathematiker <R>Arb19, S. 4, Abs. 3</R> und wird später als "the intelligence behind [...] McCulloch" bezeichnet: Mit der Hilfe des knapp 19 jährigen Pitts verfaßt der mittlerweile über 40jährige McCulloch in nur wenigen Monaten nach ihrem Kennenlernen das berühmte Papier <R>Cow98, S. 104, Abs. 3 f.</R>




[^1]: Die Aussagenlogik beschäftigt sich mit der Verknüpfung von Aussagen und deren Wertigkeit unter der Berücksichtigung der Wahrheitswerte "wahr" und "falsch" <R>Rau88</R>
