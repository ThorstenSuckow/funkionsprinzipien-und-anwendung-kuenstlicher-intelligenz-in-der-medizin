...
Für ihren Kalkül gehen sie von folgenden Eigenschaften von Nervenzellen:
...
Die Modellierung der o.g. Eigenschaften erfolgt mittels aussagenlogischer Notationen, die aus der PM übernommen worden, und als sperrig gilt [^9]. Im folgenden <R>AR88, S. 16, Abs. 3</R>



[^8]: Nach <R>Lev94, S. 2</R> liest Pitts die Principia Mathematica mit 12 Jahren
[^9]: Eine ausführliche Übersicht findet sich unter https://plato.stanford.edu/entries/pm-notation/ (abgerufen 10.8.2023)
