...
[^20]:  Ein rekurrentes neuronales Netz "speist seine Ausgaben wieder in seine eigenen Eingaben ein" <R>RN09, S. 847</R>
[^21]: Eine _Schlinge_ (engl. _loop_) in einem Graphen ist ein Kantenzug, der einen Knoten mit sich selbst verbindet <R>Die17 S. 30</R>
